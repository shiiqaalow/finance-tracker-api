...
export const Profile = () => {
  ...
  // const user?.profilePicture = user?.user?.profilePicture || "https://i.pravatar.cc/300";
    ...
    <>
      ...
      {uploadMutation.isPending && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-md">
          <div className="w-80 rounded-2xl border bg-background p-8 shadow-2xl">
            <div className="text-center">
              <h2 className="text-lg font-semibold">
                Uploading Profile Picture
              </h2>

              <p className="flex flex-col items-center gap-4 mt-2 text-sm text-muted-foreground">
                <Loader2 className="h-10 w-10 animate-spin text-primary text-center" />
                Please wait...
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center gap-6 -mt-24 md:-mt-20 md:flex-row md:items-end">
              ...
              <div className="flex-1 text-center md:text-left pb-5">
                <div className="flex flex-col gap-3 md:flex-row md:items-center">
                  <h1 className="text-3xl font-bold capitalize md:text-white">
                    {user?.name}
                  </h1>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div>
                    ...
                    <Input
                      ...
                      disabled={!isEdit}
                      className="mt-2 rounded-md border bg-background p-5 focus:border-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-2 rounded-md border bg-background p-5 focus:border-none text-gray-500"
                    />
                  </div>
                </div>
              </CardContent>
